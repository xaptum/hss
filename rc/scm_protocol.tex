...
{\Huge\bfseries  
	...
	\begin{bytefield}[bitwidth=1.7em]{32}
		\bitheader{0,8,16,24,31} \\
			\bitbox{8}{bOPCode (0x00)} &
			\bitbox{8}{bMsgID} &
			\bitbox{8}{bSockID} &
			\bitbox{8}{bPayloadLen (0x04)} \\
	...
	\begin{bytefield}[bitwidth=1.7em]{32}
		\bitheader{0,8,16,24,31} \\
		\bitbox{8}{bOPCode (0x06)} &
		\bitbox{8}{bMsgID} &
		\bitbox{8}{bSockID} &
		\bitbox{8}{bPayloadLen (0x00)} \\
	\end{bytefield}\\
	...
	\begin{bytefield}[bitwidth=1.7em]{32}
	\bitheader{0,8,16,24,31} \\
	\bitbox{8}{bOPCode (0x04)} &
	\bitbox{8}{bMsgID} &
	\bitbox{8}{bSockID} &
	\bitbox{8}{bPayloadLen} \\
	\bitbox{8}{bOrigOpCode} &
	\bitbox{8}{Reserved} &
	\bitbox{16}{Return data (Up to 56 bytes)}\\
	\end{bytefield}\\
	...
	\begin{bytefield}[bitwidth=1.7em]{32}
		...
		\bitbox{8}{bOPCode (0x01)} &
		\bitbox{8}{bMsgID} &
		\bitbox{8}{bSockID} &
		\bitbox{8}{bPayloadLen (0x08)} \\
		\bitbox{8}{bFamily (0x00)} &
		\bitbox{8}{Reserved} &
		\bitbox{16}{wPort (in Network Byte Order\footnotemark)}\\
	...
	\begin{bytefield}[bitwidth=1.7em]{32}
		...
		\bitbox{8}{bMsgID} &
		\bitbox{8}{bSockID} &
		\bitbox{8}{bPayloadLen (0x24)} \\
		\bitbox{8}{bFamily (0x01)} &
		\bitbox{8}{Reserved} &
		\bitbox{16}{wPort (in network byte order)}\\
		\bitbox{32}{dFlowInfo} \\
		\bitbox{32}{dScopeID} \\
